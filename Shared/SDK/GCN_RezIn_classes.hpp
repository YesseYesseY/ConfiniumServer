...
public:
	...
	struct FGuid                                  Material_Override_ID;                              // 0x05DC(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_5EC[0x4];                                      // 0x05EC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FFortPawnMaterialOverrideCopiedParameters Copied_Parameters;                              // 0x05F0(0x0030)(Edit, BlueprintVisible, DisableEditOnInstance)
