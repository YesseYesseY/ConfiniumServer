...
struct BattlePassScreenS19_OnInsufficientResource final
{
public:
...
DUMPER7_ASSERTS_BattlePassScreenS19_OnInsufficientResource;
...
// 0x0010 (0x0010 - 0x0000)
struct BattlePassScreenS19_OnSetResourcePrice final
{
public:
	int32                                         Cost;                                              // 0x0000(0x0004)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
DUMPER7_ASSERTS_BattlePassScreenS19_OnSetResourcePrice;
