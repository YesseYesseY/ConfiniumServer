...
public:
	...
	class ABGA_PhysicsTreeLog_C*                  K2Node_DynamicCast_AsBGA_Physics_Tree_Log;         // 0x0100(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FHitResult                             CallFunc_K2_SetWorldTransform_SweepHitResult;      // 0x0118(0x009C)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
