...
public:
	...
	class UNiagaraComponent*                      K2Node_CustomEvent_Spawned_Teleport_In_FX;         // 0x0138(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TSoftObjectPtr<class UMaterialInterface>      CallFunc_Conv_ObjectToSoftObjectReference_ReturnValue; // 0x0148(0x0028)(UObjectWrapper, HasGetValueTypeHash)
	struct FGuid                                  CallFunc_ApplyMaterialOverrideLocal_ReturnValue;   // 0x0170(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
