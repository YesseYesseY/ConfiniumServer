...
enum class EMutatorMovementMode : uint8
{
	None                                     = 0,
	BuffetBubbles                            = 20,
	BuffetBubblesIntro                       = 21,
	BuffetFlying                             = 22,
	BuffetFlyingRicochet                     = 23,
	EMutatorMovementMode_MAX                 = 24,
};
...
// ScriptStruct SpecialEventGameplayRuntime.DamageRecordEntry
// 0x003C (0x0048 - 0x000C)
struct FDamageRecordEntry final : public FFastArraySerializerItem
{
public:
	int32                                         RelevancyGroupIndex;                               // 0x000C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DamageTotal;                                       // 0x0010(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         EndReplicationTime;                                // 0x0014(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bHasDoneSpecialRelevancyDeath;                     // 0x0018(0x0001)(ZeroConstructor, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_19[0x7];                                       // 0x0019(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FUniqueNetIdRepl                       PlayerId;                                          // 0x0020(0x0028)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
DUMPER7_ASSERTS_FDamageRecordEntry;

// ScriptStruct SpecialEventGameplayRuntime.DamageRecordArray
// 0x0018 (0x0120 - 0x0108)
struct FDamageRecordArray final : public FFastArraySerializer
{
public:
	TArray<struct FDamageRecordEntry>             Entries;                                           // 0x0108(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	class USpecialRelevancyHealthComponent*       ParentComp;                                        // 0x0118(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
DUMPER7_ASSERTS_FDamageRecordArray;
