...
{
public:
	uint8                                         AssociatedSquadID;                                 // 0x0F00(0x0001)(BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, ExposeOnSpawn, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_F01[0x7];                                      // 0x0F01(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FScalableFloat                         TrigerActivationDelayCurve;                        // 0x0F08(0x0028)(Edit, BlueprintVisible, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FSlateBrush                            MiniMapIconBrush;                                  // 0x0F30(0x00B0)(Edit, BlueprintVisible, Protected, NativeAccessSpecifierProtected)
	class UFortSimpleMiniMapIndicator*            MinimapIndicator;                                  // 0x0FE0(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   InstancedLootTierGroup;                            // 0x0FE8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class FName>                           LootTierGroups;                                    // 0x0FF0(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<struct FFriendChestRoundPacing>        RoundPacingForSquadSize;                           // 0x1000(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_1010[0x10];                                    // 0x1010(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<int32, struct FFriendChestPlayerActivationPair> ActivationTimers;                           // 0x1020(0x0050)(Transient, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1070[0x8];                                     // 0x1070(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UFriendChestAnalytics*                  Analytics;                                         // 0x1078(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
