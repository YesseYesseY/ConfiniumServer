...
void UNPCStatusWidget_C::Set_Keep_Visibility_On(bool KeepVisibilityOn_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("NPCStatusWidget_C", "Set Keep Visibility On");

	Params::NPCStatusWidget_C_Set_Keep_Visibility_On Parms{};
