...
void ABGA_ButterCakeFruitPlant_C::OnLoaded_73107C82470A66DB1848FA81472288CE(class UObject* Loaded)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BGA_ButterCakeFruitPlant_C", "OnLoaded_73107C82470A66DB1848FA81472288CE");

	Params::BGA_ButterCakeFruitPlant_C_OnLoaded_73107C82470A66DB1848FA81472288CE Parms{};
...
void ABGA_ButterCakeFruitPlant_C::OnRep_PickUpSound()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BGA_ButterCakeFruitPlant_C", "OnRep_PickUpSound");
...
// Parameters:
// class UFortWorldItemDefinition*         Target                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABGA_ButterCakeFruitPlant_C::PlayPickUpAudio(class UFortWorldItemDefinition* Target)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BGA_ButterCakeFruitPlant_C", "PlayPickUpAudio");

	Params::BGA_ButterCakeFruitPlant_C_PlayPickUpAudio Parms{};
