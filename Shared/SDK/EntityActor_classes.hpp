...
// Class EntityActor.PlayerUIComponent
// 0x0128 (0x0208 - 0x00E0)
class UPlayerUIComponent final : public UEntityActorPlayerComponent
{
public:
	uint8                                         Pad_E0[0x10];                                      // 0x00E0(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVUINetSocket_Array                    NetSockets;                                        // 0x00F0(0x0118)(Net, NativeAccessSpecifierPrivate)

public:
	void ServerHandleClientResponse(class FName SocketID, const class FString& InResponse);

public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("PlayerUIComponent")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"PlayerUIComponent")
	}
	static class UPlayerUIComponent* GetDefaultObj()
	{
		return GetDefaultObjImpl<UPlayerUIComponent>();
	}
};
DUMPER7_ASSERTS_UPlayerUIComponent;
