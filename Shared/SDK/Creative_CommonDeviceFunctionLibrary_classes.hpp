...
public:
	...
	static void Apply_Vent_Recently_Launched_Tag_or_Abort_Launch(class AActor* ActorToLaunch, class AActor* VentActor, class UObject* __WorldContext, bool* ShouldLaunch);
