...
// ScriptStruct EntityCore.VUINetSocket
// 0x0034 (0x0040 - 0x000C)
struct FVUINetSocket final : public FFastArraySerializerItem
{
public:
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class APlayerController*                      Owner;                                             // 0x0010(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   NetSocketId;                                       // 0x0018(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class FName>                           PlayerData;                                        // 0x0020(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<class FName>                           ValidResponses;                                    // 0x0030(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
};
DUMPER7_ASSERTS_FVUINetSocket;

// ScriptStruct EntityCore.VUINetSocket_Array
// 0x0010 (0x0118 - 0x0108)
struct FVUINetSocket_Array final : public FFastArraySerializer
{
public:
	TArray<struct FVUINetSocket>                  Entries;                                           // 0x0108(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
DUMPER7_ASSERTS_FVUINetSocket_Array;
