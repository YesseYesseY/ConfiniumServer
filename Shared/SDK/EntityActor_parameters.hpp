...
// 0x0018 (0x0018 - 0x0000)
struct PlayerUIComponent_ServerHandleClientResponse final
{
public:
	class FName                                   SocketID;                                          // 0x0000(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 InResponse;                                        // 0x0008(0x0010)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
DUMPER7_ASSERTS_PlayerUIComponent_ServerHandleClientResponse;
