...
// Function BattlePassS19UI.BattlePassScreenS19.OnInsufficientResource
// (Event, Protected, BlueprintEvent)
// Parameters:
...
void UBattlePassScreenS19::OnInsufficientResource(const class UFortPersistentResourceItemDefinition* PersistentResource)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BattlePassScreenS19", "OnInsufficientResource");

	Params::BattlePassScreenS19_OnInsufficientResource Parms{};
...
// Function BattlePassS19UI.BattlePassScreenS19.OnSetResourcePrice
// (Event, Protected, BlueprintEvent)
// Parameters:
// const int32                             Cost                                                   (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const class UFortPersistentResourceItemDefinition*PersistentResource                                     (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UBattlePassScreenS19::OnSetResourcePrice(const int32 Cost, const class UFortPersistentResourceItemDefinition* PersistentResource)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BattlePassScreenS19", "OnSetResourcePrice");

	Params::BattlePassScreenS19_OnSetResourcePrice Parms{};
