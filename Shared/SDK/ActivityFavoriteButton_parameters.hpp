...
struct ActivityFavoriteButton_C_ExecuteUbergraph_ActivityFavoriteButton final
{
public:
...
DUMPER7_ASSERTS_ActivityFavoriteButton_C_ExecuteUbergraph_ActivityFavoriteButton;

// Function ActivityFavoriteButton.ActivityFavoriteButton_C.PreConstruct
// 0x0001 (0x0001 - 0x0000)
struct ActivityFavoriteButton_C_PreConstruct final
{
public:
	bool                                          IsDesignTime;                                      // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_ActivityFavoriteButton_C_PreConstruct;
