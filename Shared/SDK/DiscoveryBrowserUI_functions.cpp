...
// Function DiscoveryBrowserUI.FortActivityModeSetSelection.OnGenerateEntryForActivity
...
void UFortActivityModeSetSelection::OnGenerateEntryForActivity(const class UFortGameActivity* GameActivity, const class FText& DisplayName)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortActivityModeSetSelection", "OnGenerateEntryForActivity");

	Params::FortActivityModeSetSelection_OnGenerateEntryForActivity Parms{};
...
// Function DiscoveryBrowserUI.FortActivityModeSetSelection.OnSelectedMnemonicChanged
// (Event, Protected, BlueprintEvent)
// Parameters:
// const class FString&                    Mnemonic                                               (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UFortActivityModeSetSelection::OnSelectedMnemonicChanged(const class FString& Mnemonic)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortActivityModeSetSelection", "OnSelectedMnemonicChanged");

	Params::FortActivityModeSetSelection_OnSelectedMnemonicChanged Parms{};
...
// Function DiscoveryBrowserUI.FortActivityModeSetSelection.ResetEntryList
// (Event, Protected, BlueprintEvent)

void UFortActivityModeSetSelection::ResetEntryList()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortActivityModeSetSelection", "ResetEntryList");
