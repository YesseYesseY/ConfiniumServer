...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// int32                                   InteractingPlayerCount                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void AGCNL_Athena_MultiInteract_C::SetPitchBasedOnPlayerCount(int32 InteractingPlayerCount, float MultiInteractMultiplier, float InteractingDuration)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GCNL_Athena_MultiInteract_C", "SetPitchBasedOnPlayerCount");

	Params::GCNL_Athena_MultiInteract_C_SetPitchBasedOnPlayerCount Parms{};

	Parms.InteractingPlayerCount = InteractingPlayerCount;
