...
public:
	...
	TArray<class AActor*>                         ClientDormantDynamicActors;                        // 0x0820(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
public:
	...
	TMap<class FString, struct FAggregatedFunction> AggregatedFunctions;                             // 0x00B8(0x0050)(Transient, NativeAccessSpecifierPrivate)
	TMap<class FName, double>                     AggregationTimeouts;                               // 0x0108(0x0050)(NativeAccessSpecifierPrivate)
	TSet<class FName>                             NoAggregationFunctions;                            // 0x0158(0x0050)(NativeAccessSpecifierPrivate)
	TMap<class FName, struct FNoAggregationParameters> NoAggregationParameters;                      // 0x01A8(0x0050)(NativeAccessSpecifierPrivate)
	TMap<class FName, struct FAggregatedFunctionConfig> AggregatedFunctionConfigs;                   // 0x01F8(0x0050)(Edit, EditConst, NativeAccessSpecifierPrivate)
