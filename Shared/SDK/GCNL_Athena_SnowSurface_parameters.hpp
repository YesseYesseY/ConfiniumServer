...
public:
	...
	TArray<class UNiagaraComponent*>              K2Node_Event_ParticleComponents_2;                 // 0x00D0(0x0010)(ConstParm, ReferenceParm, ContainsInstancedReference)
	...
	class AFortReplaySpectatorAthena*             K2Node_DynamicCast_AsFort_Replay_Spectator_Athena; // 0x01F0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FGameplayCueParameters                 K2Node_Event_Parameters;                           // 0x0208(0x00C0)(ConstParm, ContainsInstancedReference)
	TArray<class UParticleSystemComponent*>       K2Node_Event_ParticleComponents;                   // 0x02C8(0x0010)(ConstParm, ReferenceParm, ContainsInstancedReference)
	TArray<class UAudioComponent*>                K2Node_Event_AudioComponents;                      // 0x02D8(0x0010)(ConstParm, ReferenceParm, ContainsInstancedReference)
