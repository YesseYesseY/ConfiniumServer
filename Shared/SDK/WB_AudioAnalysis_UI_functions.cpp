...
// Function WB_AudioAnalysis_UI.WB_AudioAnalysis_UI_C.ClearMPCParameters
// (Event, Public, BlueprintEvent)

void UWB_AudioAnalysis_UI_C::ClearMPCParameters()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WB_AudioAnalysis_UI_C", "ClearMPCParameters");
