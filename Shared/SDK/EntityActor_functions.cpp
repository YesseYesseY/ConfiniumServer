...
// Function EntityActor.PlayerUIComponent.ServerHandleClientResponse
// (Net, NetReliable, Native, Event, Public, NetServer, NetValidate)
// Parameters:
// class FName                             SocketID                                               (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const class FString&                    InResponse                                             (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UPlayerUIComponent::ServerHandleClientResponse(class FName SocketID, const class FString& InResponse)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PlayerUIComponent", "ServerHandleClientResponse");

	Params::PlayerUIComponent_ServerHandleClientResponse Parms{};
