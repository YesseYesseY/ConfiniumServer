...
void ANPC_Pawn_Wildlife_Parent_C::UpdateNPCStatusWidgetKeepVisible(bool ShouldKeepVisible)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("NPC_Pawn_Wildlife_Parent_C", "UpdateNPCStatusWidgetKeepVisible");

	Params::NPC_Pawn_Wildlife_Parent_C_UpdateNPCStatusWidgetKeepVisible Parms{};
