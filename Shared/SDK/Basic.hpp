...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0B79F1C8;
	constexpr int32 AppendString      = 0x00B290D0;
	constexpr int32 GNames            = 0x0B9B5D40;
	constexpr int32 GWorld            = 0x0B973AA8;
	constexpr int32 ProcessEvent      = 0x00C456B4;
