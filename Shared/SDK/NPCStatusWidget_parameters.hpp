...
public:
	...
	bool                                          K2Node_CustomEvent_KeepVisibilityOn;               // 0x002D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_NPCStatusWidget_C_ExecuteUbergraph_NPCStatusWidget;

// Function NPCStatusWidget.NPCStatusWidget_C.Set Keep Visibility On
// 0x0001 (0x0001 - 0x0000)
struct NPCStatusWidget_C_Set_Keep_Visibility_On final
{
public:
...
DUMPER7_ASSERTS_NPCStatusWidget_C_Set_Keep_Visibility_On;
